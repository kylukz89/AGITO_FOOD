...
public class EntidadeProdutosGrupoEscolhido {
    ...
    public EntidadeProdutosGrupoEscolhido(int id, int grupo, String nomeOpcao, Bitmap imagem, double valor, Context ctx, boolean seTemEtapasPersonalizadas, String descricao, HashMap<Integer, ArrayList> itensAdicionais, ArrayList<String> etapas) {
        this.id = id;
        this.grupo = grupo;
