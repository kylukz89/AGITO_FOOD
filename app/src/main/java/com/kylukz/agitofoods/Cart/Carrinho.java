package com.kylukz.agitofoods.Cart;
...
import com.kylukz.agitofoods.DAO.PedidoDAO;
import com.kylukz.agitofoods.R;
import com.google.android.material.bottomsheet.BottomSheetBehavior;
import com.kylukz.agitofoods.Adapters.ProdutoGrupoPizzaAdapter;
...
//                        entidadeItemEscolhido.setId(.);
    ...
    /**
     * Finaliza e envia para servidor o pedido realizado
     * bem como valor e forma de pagamento escolhida
     *
     * @author Igor Maximo
     * @date 08/03/2021
     */
    public Object[] setFinalizarPedidoCarrinho() {
        return new PedidoDAO().setEnviarFinalizarPedido(VALOR_TOTAL_CARRINHO, VALOR_TOTAL_CREDITO, VALOR_TOTAL_DEBITO, VALOR_TOTAL_RECEBER_LOCAL, ENTIDADES_ITENS_ESCOLHIDOS_DO_CARRINHO);
    }
